...
<body>
	<div class="container">
		...
		at the same time.</p>
		<p>Here is a simple example of an xkcd password generator. Enter the number of words you want in the password and select to add a symbol 
		and/or a number. Then click the button to get a new password.</p><br>
